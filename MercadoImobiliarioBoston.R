...
# Poderíamos continuar pedindo mais "dobras" para o modelo e aumentar o nível de complexidade de detalhamento, porém, fazer "dobras" demais pode onerar um pouco o processamento da nossa máquina e o nosso senso de interpretação da árvore, dificultando uma análise mais enxuta.
